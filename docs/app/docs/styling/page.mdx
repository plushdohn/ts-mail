...
`ts-email` provides a way to override the default styles of your email via the `styles` option. You can customize colors, fonts, borders, and other visual aspects, or override specific style tokens as needed.
